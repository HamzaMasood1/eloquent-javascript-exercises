...
// // you can define a range {2,4} min 2 and max 4 times the pattern should repeat
...
// // ////////////////////Matches and groups/////////////////
// //execute retuns null if no match and return object with info if match.
...
// //string values also have a match method that behaves simlarly
// console.log("one two 100".match(/\d+/));
// // → ["100"]

//after ' (then anything that is not ') *
let quotedText = /'([^']*)'/;
